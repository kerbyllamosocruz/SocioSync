// ==UserScript==
// @name            TimerHooker English Version (TikTok 10x Default)
// @name:en         TimerHooker English Version (TikTok 10x Default)
// @version         1.2.2
// @description     Control page timer speed | Speed up to skip page timing ads | Video fast forward (slow play) | Skip ads | Support almost all web pages. Defaults to 10x on tiktok.com.
// @description:en  it can hook the timer speed to change. Defaults to 10x on tiktok.com.
// @include         *
...
~(function (global) {
  ...
  var generate = function () {
    return function (util) {
      ...
      var timerHooker = {
        ...
        notifyExec: function (uniqueId) {
          ...
          if (uniqueId) {
            ...
            var timeoutInfos = Object.values(this._timeoutIds).filter(function (info) {
      ...
      // Auto-set default speed to 20x on tiktok.com
      if (window.location.hostname.includes("tiktok.com")) {
        timerHooker.change(1 / 20);
      }
